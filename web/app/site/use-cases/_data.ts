...
const PROPERTY: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of issue", p: "A Bitcoin timestamp pins when the document existed — decisive for start dates, completion, priority, and which version was signed." },
  ...
  webSteps: [
    ...
    { h: "Anchored and logged automatically", p: "The fingerprint is timestamped on Bitcoin and written to the public transparency log. You get back a normal PDF that also verifies." },
...
const EDUCATION: Sector = {
  ...
  proves: [
    ...
    { h: "Issued at a fixed date", p: "The award date is timestamped on Bitcoin, so a certificate's date of issue can't be quietly back- or forward-dated." },
  ...
  webSteps: [
    ...
    { h: "Sealed, anchored, and delivered", p: "Every certificate is sealed with your certificate, timestamped on Bitcoin, and emailed to the recipient with a proof link." },
...
issued   248 credentials
  each   sealed · anchored to Bitcoin · emailed with a proof link
...
const MEDIA: Sector = {
  ...
  proves: [
    ...
    { h: "Captured at a fixed time", p: "A Bitcoin timestamp pins when the asset existed — decisive for breaking news, first-publication, and licensing disputes." },
  ...
  webSteps: [
    ...
    { h: "Anchored and logged automatically", p: "The fingerprint is timestamped on Bitcoin and recorded in the public transparency log. You get back the same file with credentials embedded." },
...
const IP: Sector = {
  ...
  metaDescription:
    "Timestamp invention disclosures, lab notebooks, and trade-secret records on Bitcoin to prove prior art and priority — free, standards-based, and the file never leaves your machine. Web app and CLI walkthrough.",
  ...
  proves: [
    { h: "You had it by a certain date", p: "An OpenTimestamps proof on Bitcoin pins the moment a disclosure or design existed — the priority evidence that decides who was first." },
    ...
    { h: "Provable for years, by anyone", p: "The Bitcoin anchor outlives any vendor. A record timestamped today stays verifiable indefinitely, with standard tools, by any examiner or court." },
  ],
  webSteps: [
...
Success! Bitcoin attests existence as of 2026-06-30`,
  ...
  faq: [
    ...
    { q: "Can I prove a date without disclosing the file?", a: "Yes. Anchor just the SHA-256 — the file never leaves your machine, only its 32-byte digest, and the Bitcoin timestamp still proves it existed by that date. You reveal the file only if and when you choose." },
    { q: "How durable is the priority evidence?", a: "The Bitcoin anchor doesn't depend on Let's Seal or any vendor. A record timestamped today stays independently verifiable for years, with standard OpenTimestamps tooling." },
    { q: "Is the timestamp credible to a court or examiner?", a: "It's an OpenTimestamps proof committed to the Bitcoin blockchain — a public, immutable ledger anyone can check. The evidence stands on that ledger, not on trusting us." },
  ],
};
...
const BANKING: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of issue", p: "Statement periods and agreement dates are timestamped on Bitcoin — decisive for affordability checks, drawdown, and disputes over which version was current." },
  ...
  webSteps: [
    ...
    { h: "Anchored and logged automatically", p: "The fingerprint is timestamped on Bitcoin and written to the public transparency log. The customer gets a normal PDF that also verifies." },
...
const ACCOUNTING: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed to the reporting date", p: "The moment of issue is timestamped on Bitcoin, so a set of accounts or an audit opinion can't be back- or forward-dated." },
  ...
  webSteps: [
    ...
    { h: "Anchored and logged automatically", p: "The fingerprint is timestamped on Bitcoin and written to the public transparency log. The client gets a normal PDF that also verifies." },
...
✓ authentic · unaltered · sealed by Let's Seal Examples`,
  ...
  faq: [
    ...
    { q: "Can accounts stay verifiable for years?", a: "Yes. The seal and the Bitcoin anchor outlive any single vendor, so a set of accounts sealed today stays independently verifiable indefinitely, with standard tools." },
...
const INVESTMENT: Sector = {
  ...
  proves: [
    ...
    { h: "Pinned to a point in time", p: "The as-at date is timestamped on Bitcoin — decisive for valuations, capital calls, and proof-of-reserves, where the moment is the whole point." },
  ...
  webSteps: [
    ...
    { h: "Anchored and logged automatically", p: "The fingerprint is timestamped on Bitcoin and written to the public transparency log. The investor gets a normal PDF that also verifies." },
...
✓ authentic · unaltered · sealed by Let's Seal Examples`,
  ...
  faq: [
    ...
    { q: "How is this useful for proof-of-reserves?", a: "Proof-of-reserves is about a specific moment. Sealing and anchoring the attestation pins it to a Bitcoin timestamp and makes it tamper-evident, so an investor can verify both what was attested and exactly when — independently of you." },
...
const CONSTRUCTION: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of inspection", p: "The issue date is timestamped on Bitcoin — decisive for the sequence of works, sign-offs, and who certified what, when." },
...
✓ authentic · unaltered · sealed by Let's Seal Examples`,
  ...
  faq: [
    ...
    { q: "Will it still verify years later, for a warranty claim?", a: "Yes. The seal and the Bitcoin anchor outlive any single vendor, so a certificate sealed today stays independently verifiable for the life of the building." },
    { q: "Does the recipient need special software?", a: "No. They get a normal PDF that opens anywhere, and it also verifies against the public portal and any standard PAdES validator." },
  ],
};
...
const SURVEYING: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed to the inspection date", p: "The as-inspected date is timestamped on Bitcoin — decisive when a valuation or condition report is relied on for a transaction or a claim." },
...
const HEALTHCARE: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of issue", p: "The issue date is timestamped on Bitcoin, so a certificate or result can't be back- or forward-dated." },
  ...
  webSteps: [
    ...
    { h: "Or timestamp a record privately", p: "For sensitive records, anchor the file's hash from the CLI — the bytes never leave your systems, only the digest, and the timestamp still verifies against Bitcoin." },
...
const PHARMA: Sector = {
  ...
  proves: [
    ...
    { h: "Contemporaneous by construction", p: "Every record is timestamped on Bitcoin and appended to a public, append-only log — an independent “this existed then” that predates any dispute." },
  ...
  webSteps: [
    ...
    { h: "Hand a regulator the proof", p: "Give the assessor the proof link or the .ots file. They verify independently, against Bitcoin and the transparency log, without access to your systems." },
  ],
  cli:
...
Success! Bitcoin attests existence as of 2026-06-30`,
  ...
  faq: [
    ...
    { q: "Can confidential trial data stay private?", a: "Yes. Anchor just the SHA-256 — the data never leaves your systems, only its 32-byte digest, and the Bitcoin timestamp still proves it existed unaltered by that date." },
    { q: "Can an inspector verify without our systems?", a: "Yes — that's the point. They verify the seal and the Bitcoin timestamp against public infrastructure, so the evidence stands even if your systems are unavailable." },
    { q: "Do records stay verifiable for the retention period?", a: "Yes. The seal and the Bitcoin anchor outlive any single vendor, so a record sealed today stays independently verifiable for years, with standard tools." },
  ],
};
...
const GOVERNMENT: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of issue", p: "The issue date is timestamped on Bitcoin — decisive for deadlines, appeal windows, and which decision was in force when." },
...
✓ authentic · unaltered · sealed by Let's Seal Examples`,
  ...
  faq: [
    ...
    { q: "Will documents stay verifiable long term?", a: "Yes. The seal and the Bitcoin anchor outlive any single vendor, so an official document sealed today stays independently verifiable for years, with standard tools." },
  ],
};
...
const HR: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of issue", p: "The issue date is timestamped on Bitcoin — useful for start dates, notice periods, and the record of a board decision." },
...
const PROCUREMENT: Sector = {
  ...
  proves: [
    ...
    { h: "Submitted on time, provably", p: "A tender or bid is timestamped on Bitcoin the moment it's sealed — independent proof it existed before the deadline, settling any dispute over lateness." },
  ...
  webSteps: [
    ...
    { h: "Anchored and logged automatically", p: "The fingerprint is timestamped on Bitcoin and written to the public transparency log. The counterparty gets a normal PDF that also verifies." },
...
✓ authentic · unaltered · sealed by Let's Seal Examples`,
  ...
  faq: [
    { q: "Can this prove a tender was submitted on time?", a: "Yes. Sealing a tender timestamps it on Bitcoin the moment it's sealed — independent evidence it existed before the deadline, which settles a dispute over whether a bid was late." },
...
const MANUFACTURING: Sector = {
  ...
  proves: [
    ...
    { h: "Fixed at the moment of issue", p: "The issue date is timestamped on Bitcoin — decisive for batch traceability, recalls, and which certificate applied to which lot." },
...
const INDIVIDUALS: Sector = {
  ...
  proves: [
    { h: "You had it by a certain date", p: "A timestamp on Bitcoin pins the moment your file existed — the evidence that settles “I had this first” for writing, designs, or ideas." },
    ...
    { h: "Free, and provable forever", p: "The Bitcoin anchor doesn't depend on any company. A file you seal today stays verifiable indefinitely, by anyone, with standard tools." },
  ],
  webSteps: [
    ...
    { h: "It's anchored on Bitcoin", p: "The file's fingerprint is timestamped on Bitcoin and recorded in the public transparency log. You get a proof link and, for files, a normal copy that also verifies." },
...
✓ authentic · unaltered`,
  ...
  faq: [
    ...
    { q: "How does this prove I created something first?", a: "It pins your file to a Bitcoin timestamp, so you can prove it existed by that date. If someone later claims the work, your dated, tamper-evident proof came first." },
